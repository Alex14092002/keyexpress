! function() {
    ...
    ! function(n) {
        ...
        function p(e, t) {
            var i, n, r, o, a, l, s, d, f, u, h, g = t && t.split("/"),
                p = c.map,
                v = p && p["*"] || {};
            if (e && "." === e.charAt(0))
                if (t) {
                    for (a = (e = e.split("/")).length - 1, c.nodeIdCompat && m.test(e[a]) && (e[a] = e[a].replace(m, "")), e = g.slice(0, g.length - 1).concat(e), f = 0; f < e.length; f += 1)
        ...
        a = function(e, t) {
            var i, n = R(e),
                r = n[0];
            return e = n[1], r && (i = b(r = p(r, t))), r ? e = i && i.normalize ? i.normalize(e, function(e) {
                return function(t) {
                    return p(t, e)
                }
            }(t)) : p(e, t) : (r = (n = R(e = p(e, t)))[0], e = n[1], r && (i = b(r))), {
                f: r ? r + "!" + e : e,
                n: e,
                pr: r,
                p: i
            ...
            if (r = r || e, "undefined" === _ || "function" === _) {
                for (t = !t.length && i.length ? ["require", "exports", "module"] : t, m = 0; m < t.length; m += 1)
                ...
                u = i ? i.apply(s[e], R) : void 0, e && (o && o.exports !== n && o.exports !== s[e] ? s[e] = o.exports : u === n && p || (s[e] = u))
            } else e && (s[e] = i)
            ...
            return t = t || function() {}, "function" == typeof i && (i = s, s = d), s ? r(n, e, t, i) : setTimeout((function() {
                r(n, e, t, i)
            }), 4), o
        }, o.config = function(e) {
            return o(e)
            ...
            t.splice || (i = t, t = []), g(s, e) || g(d, e) || (d[e] = [e, t, i])
        }).amd = {
            jQuery: !0
        }
        ...
        return Backbone.Model.extend({
            ...
            initialize: function() {
                var t = this.get("type");
                this.set("formID", this.collection.options.formModel.get("id")), this.listenTo(nfRadio.channel("form-" + this.get("formID")), "reset", this.resetModel), this.bind("change", this.changeModel, this), this.bind("change:value", this.changeValue, this), this.set("errors", new e), "listimage" === t && (this.get = this.listimageGet, this.set = this.listimageSet), nfRadio.channel("fields").trigger("init:model", this), nfRadio.channel(this.get("type")).trigger("init:model", this), nfRadio.channel("fields-" + this.get("type")).trigger("init:model", this), void 0 !== this.get("parentType") && nfRadio.channel(this.get("parentType")).trigger("init:model", this), this.listenTo(nfRadio.channel("form-" + this.get("formID")), "loaded", this.formLoaded), this.listenTo(nfRadio.channel("form-" + this.get("formID")), "before:submit", this.beforeSubmit)
            },
            listimageGet: function(e) {
                return "options" === e && (e = "image_options"), Backbone.Model.prototype.get.call(this, e)
            },
            listimageSet: function(e, t) {
                return "options" === e && (e = "image_options"), Backbone.Model.prototype.set.call(this, e, t)
            },
        ...
        return Marionette.Object.extend({
            ...
            getField: function(e) {
                ...
                })), void 0 === t && (t = nfRadio.channel("field-repeater").request("get:repeaterFieldById", e)), t
            }
        })
        ...
        return Marionette.Object.extend({
            initialize: function() {
                this.listenTo(e, "change:modelValue", this.onChangeModelValue), this.listenTo(e, "keyup:field", this.dateKeyup), this.listenTo(e, "blur:field", this.onBlurField), this.listenTo(e, "change:extra", this.changeHoursMinutes, this)
            },
            onChangeModelValue: function(e) {
                this.dateChange(e)
            },
            ...
            dateKeyup: function(e, i, n) {
                ...
                var r = jQuery(e).val(),
                    o = i.get("id"),
                    a = i.get("date_format");
                if (0 == r.length) nfRadio.channel("fields").request("remove:error", o, t);
            ...
            changeHoursMinutes: function(e, t) {
                ...
                t.set("selected_hour", n), t.set("selected_minute", r), t.set("selected_ampm", o), t.trigger("change:value", t)
            }
        })
        ...
        return Marionette.Object.extend({
            ...
            renderOptions: function() {
                ...
                if (_.each(this.options, (function(i, n) {
                        Array.isArray(this.value) && (Array.isArray(this.value[0]) && -1 !== _.indexOf(this.value[0], i.value) || _.indexOf(this.value, i.value)) && (t = !0), i.value == this.value && (t = !0), void 0 === i.visible && (i.visible = !0), i.fieldID = this.id, i.classes = this.classes, i.index = n, i.label = void 0 !== nfFrontEnd.filter_esc_status && "true" === nfFrontEnd.filter_esc_status ? _.escape(i.label) : i.label;
                        var r = !1;
                        Array.isArray(this.value) && 0 < this.value.length ? -1 === _.indexOf(this.value[0].split(","), i.value) && -1 === _.indexOf(this.value, i.value) || (r = !0) : _.isArray(this.value) || i.value != this.value ? 1 == i.selected && this.clean && void 0 === this.value && (r = !0) : r = !0, i.selected = r, i.isSelected = r, i.required = this.required, i.maybeFilterHTML = this.maybeFilterHTML;
        ...
        return Marionette.Object.extend({
            initialize: function() {
                this.listenTo(nfRadio.channel("listimage"), "init:model", this.register), nfRadio.channel("listimage").reply("before:updateField", this.beforeUpdateField, this), nfRadio.channel("listimage").reply("get:calcValue", this.getCalcValue, this)
            },
            register: function(e) {
                if (e.set("renderOptions", this.renderOptions), e.set("renderOtherText", this.renderOtherText), e.set("selected", []), 0 != e.get("image_options").length) {
            ...
            renderOptions: function() {
                ...
                1 === this.allow_multi_select ? (this.old_classname = "list-checkbox", this.image_type = "checkbox") : this.image_type = "radio", "horizontal" === this.list_orientation ? this.flex_direction = "row" : this.flex_direction = "column";
                var i = this,
                    n = parseInt(this.num_columns) || 1,
                    r = 1,
                    o = 1;
                if (_.each(this.image_options, (function(a, l) {
                        this.show_option_labels ? a.label = void 0 !== nfFrontEnd.filter_esc_status && "true" === nfFrontEnd.filter_esc_status ? _.escape(a.label) : a.label : a.label = "", Array.isArray(this.value) && (Array.isArray(this.value[0]) && -1 !== _.indexOf(this.value[0], a.value) || _.indexOf(this.value, a.value)) && (t = !0), a.value == this.value && (t = !0), void 0 === a.visible && (a.visible = !0), "horizontal" === i.list_orientation && r <= n && (a.styles = "margin:auto;grid-column: " + r + "; grid-row = " + o, r === n ? (r = 1, o += 1) : r += 1), a.image_type = i.image_type, a.fieldID = this.id, a.classes = this.classes, a.index = l;
                        var s = !1;
                        Array.isArray(this.value) && 0 < this.value.length ? -1 === _.indexOf(this.value[0].split(","), a.value) && -1 === _.indexOf(this.value, a.value) || (s = !0) : (_.isArray(this.value) || a.value != this.value) && (1 != a.selected || !this.clean || void 0 !== this.value && "" !== this.value) || (s = !0), a.selected = s, a.isSelected = s, a.required = this.required, a.maybeFilterHTML = this.maybeFilterHTML;
            ...
            getCalcValue: function(e) {
                var t = 0,
                    i = e.get("options");
                if (0 != i.length)
                    if (1 == parseInt(e.get("allow_multi_select"))) _.each(e.get("value"), (function(e) {
                        var n = _.find(i, (function(t) {
                            return t.value == e
                        }));
                        t += Number(n.calc)
            ...
            beforeUpdateField: function(e, t) {
                if (1 !== t.get("allow_multi_select")) {
                    ...
                    _.each(n, (function(e, t) {
                        e.value === i ? (e.isSelected = !0, e.selected = !0) : (e.isSelected = !1, e.selected = !1), e.isSelected ? (jQuery("#nf-field-" + e.fieldID + "-" + t).addClass("nf-checked"), jQuery("#nf-label-field-" + e.fieldID + "-" + t).addClass("nf-checked-label")) : (e.selected = !1, jQuery("#nf-field-" + e.fieldID + "-" + t).removeClass("nf-checked"), jQuery("#nf-label-field-" + e.fieldID + "-" + t).removeClass("nf-checked-label"))
                    }))
                } else {
                    "string" == typeof(i = t.get("value") || []) && (i = [i]);
                    var r = jQuery(e).val();
                    if (jQuery(e).prop("checked")) i.push(r), jQuery(e).addClass("nf-checked"), jQuery(e).parent().find('label[for="' + jQuery(e).prop("id") + '"]').addClass("nf-checked-label");
                    else {
                        jQuery(e).removeClass("nf-checked"), jQuery(e).parent().find('label[for="' + jQuery(e).prop("id") + '"]').removeClass("nf-checked-label");
                        var o = i.indexOf(r);
                        if (-1 != o) i.splice(o, 1);
                            ...
                            var a = i[0].split(","),
                                l = a.indexOf(r); - 1 !== l && a.splice(l, 1), i = a.join(",")
                        }
                    }
                }
                return _.clone(i)
        ...
        return Marionette.Object.extend({
            ...
            renderOptions: function() {
                ...
                if (_.each(this.options, (function(i, n) {
                        i.value == this.value && (t = !0), void 0 === i.visible && (i.visible = !0), i.selected = !1, i.fieldID = this.id, i.classes = this.classes, i.currentValue = this.value, i.index = n, i.label = void 0 !== nfFrontEnd.filter_esc_status && "true" === nfFrontEnd.filter_esc_status ? _.escape(i.label) : i.label, i.required = this.required, this.clean && 1 == this.selected || this.value == i.value ? i.selected = !0 : i.selected = !1, i.maybeFilterHTML = this.maybeFilterHTML;
        ...
        return Marionette.Object.extend({
            ...
            validateMinMax: function(e, t) {
                ...
                if (o && n > o) {
                    l = nfRadio.channel("fields").request("get:field", t.get("id")), s = nfRadio.channel("app").request("get:form", l.get("formID"));
        ...
        return Marionette.Object.extend({
            ...
            confirmKeyup: function(e, i, n) {
                ...
                if (i.get("confirm_field")) var o = i,
                    ...
                    s = r;
                else if (i.get("confirm_with")) a = (o = nfRadio.channel("fields").request("get:field", i.get("confirm_with"))).get("id"), l = s = o.get("value");
                if (void 0 !== o)
                    if ("" == s) nfRadio.channel("fields").request("remove:error", a, t);
                    else if (r == l) nfRadio.channel("fields").request("remove:error", a, t);
                else {
        ...
        return Marionette.Object.extend({
            ...
            validateRequired: function(e, t) {
                ...
                var i = jQuery(e).val(),
                    ...
                    r = !0,
                    o = t.get("mask");
                if (o && (o = (o = (o = o.replace(/9/g, "_")).replace(/a/g, "_")).replace(/\*/g, "_")), o && i === o && 0 < t.get("errors").length && (r = !1), jQuery.trim(i) || (r = !1), void 0 !== n) var a = n;
                else a = r;
                this.maybeError(a, t)
            },
            validateModelData: function(e) {
        ...
        return Marionette.Object.extend({
            ...
            register: function(e) {
                if (e.set("renderOptions", this.renderOptions), e.set("renderOtherAttributes", this.renderOtherAttributes), 0 != e.get("options").length) {
                    var t = e.get("value");
                    if ("listmultiselect" == e.get("type")) var i = _.filter(e.get("options"), (function(e) {
                            return 1 == e.selected
                        })),
                        ...
                        if (void 0 === (i = _.find(e.get("options"), (function(e) {
                                return 1 == e.selected
                            }))) && (i = _.first(e.get("options"))), void 0 !== i && void 0 !== i.value) n = i.value;
            ...
            renderOptions: function() {
                ...
                return _.each(this.options, (function(t) {
                    if (_.isArray(this.value)) {
                        ...
                        if (1 == t.selected && this.clean && void 0 === this.value) i = !0;
                        else i = !1;
                    else var i = !0;
                    void 0 === t.visible && (t.visible = !0), t.selected = i, t.fieldID = this.id, t.classes = this.classes, t.currentValue = this.value, t.label = void 0 !== nfFrontEnd.filter_esc_status && "true" === nfFrontEnd.filter_esc_status ? _.escape(t.label) : t.label, t.maybeFilterHTML = this.maybeFilterHTML;
        ...
        return Marionette.Object.extend({
            ...
            renderProductQuantity: function() {
                if (1 == this.product_use_quantity) return nfRadio.channel("app").request("get:template", "#tmpl-nf-product-quantity")(this)
            },
            renderOptions: function() {
                var e = this,
                    t = "";
        ...
        return Marionette.Object.extend({
            ...
            getCalcValue: function(e) {
                var t = nfRadio.channel(e.get("type")).request("get:calcValue", e),
                    i = e.get("value");
                void 0 !== t && (t || 0 === t) && (i = t);
                var r = new n(nfi18n.siteLocale, nfi18n.thousands_sep, nfi18n.decimal_point),
                    o = r.numberDecoder(i),
                    a = r.numberEncoder(i);
        ...
        return Marionette.Object.extend({
            ...
            dateBackwardsCompat: function(e, t) {
                if (e.pikaday = {}, e.pikaday._o = {}, nfRadio.channel("pikaday").trigger("init", e, t), void 0 !== e.pikaday._o.disableDayFn && e.set("disable", [e.pikaday._o.disableDayFn]), void 0 !== e.pikaday._o.i18n || void 0 !== e.pikaday._o.firstDay) {
                    let t = e.config.locale;
                    void 0 !== e.pikaday._o.firstDay && (t.firstDayOfWeek = e.pikaday._o.firstDay), void 0 !== e.pikaday._o.i18n && (void 0 !== e.pikaday._o.i18n.weekdays && (t.weekdays.longhand = e.pikaday._o.i18n.weekdays), void 0 !== e.pikaday._o.i18n.weekdaysShort && (t.weekdays.shorthand = e.pikaday._o.i18n.weekdaysShort), void 0 !== e.pikaday._o.i18n.months && jQuery(".flatpickr-monthDropdown-months > option").each((function() {
                        this.text = e.pikaday._o.i18n.months[this.value]
                    }))), e.set("locale", t)
                }
                Object.keys(e.pikaday._o).length > 0 && (console.log("%cDeprecated Ninja Forms Pikaday custom code detected.", "color: Red; font-size: large"), console.log("You are using deprecated Ninja Forms Pikaday custom code. Support for this custom code will be removed in a future version of Ninja Forms. Please contact Ninja Forms support for more details."))
            }
        })
    })), i("controllers/fieldDate", [], (function() {
        return Marionette.Object.extend({
            initialize: function() {
                this.listenTo(nfRadio.channel("date"), "init:model", this.registerFunctions), this.listenTo(nfRadio.channel("date"), "render:view", this.initDatepicker)
            },
            registerFunctions: function(e) {
                e.set("renderHourOptions", this.renderHourOptions), e.set("renderMinuteOptions", this.renderMinuteOptions), e.set("maybeRenderAMPM", this.maybeRenderAMPM), e.set("customClasses", this.customClasses), e.getValue = this.getValue
            },
            ...
            maybeRenderAMPM: function() {
                if (void 0 !== this.hours_24 && 1 != this.hours_24) return '<div style="float:left;"><select class="ampm extra"><option value="am">AM</option><option value="pm">PM</option></select></div>'
            },
            initDatepicker: function(e) {
                e.model.set("el", e.el);
                var t = jQuery(e.el).find(".nf-element")[0];
                if (e.listenTo(nfRadio.channel("form-" + e.model.get("formID")), "before:submit", this.beforeSubmit, e), void 0 !== e.model.get("date_mode") && "time_only" == e.model.get("date_mode")) return jQuery(t).hide(), !1;
                var i = e.model.get("date_format");
                "" != i && "default" != i || (i = this.convertDateFormat(nfi18n.dateFormat), e.model.set("date_format", i));
                var n = {
                ...
                void 0 !== r && (n = r);
                var o = flatpickr(t, n);
                1 == e.model.get("date_default") && (o.setDate(moment().format(i)), e.model.set("value", moment().format(i))), nfRadio.channel("pikaday-bc").trigger("init", o, e.model, e), nfRadio.channel("flatpickr").trigger("init", o, e.model, e)
            },
            beforeSubmit: function(e) {
            ...
            getYearRange: function(e) {
                ...
                return t && i ? [t, i] : t ? [t, i = t + 10] : i ? [t = i - 10, i] : 10
            },
            ...
            getValue: function() {
                ...
                o = _.isObject(r) ? r.date : r;
                let a = "";
                return void 0 !== o && (a += o), void 0 !== t && void 0 !== i && (a += " " + t + ":" + i), void 0 !== n && (a += " " + n), a
            }
        })
        ...
        return Marionette.Object.extend({
            ...
            initRecaptcha: function(e) {
                ...
                try {
                    nfRadio.channel("form-" + t).trigger("disable:submit", e), grecaptcha.ready((function() {
                        grecaptcha.execute(e.get("site_key"), {
                            action: "register"
                        }).then((function(i) {
                            e.set("value", i), nfRadio.channel("form-" + t).trigger("enable:submit", e)
                        }))
                    }))
                } catch (t) {
                    jQuery(document).on("nfFormReady", (t => {
                        ...
                        })), nfRadio.channel("fields").request("add:error", i, "recaptcha-v3-missing", e.collection.options.formModel.get("settings").recaptchaConsentMissing), this.nf_build_default_consent_action(e, n.services, i, t)
                    }))
                }
            },
            nf_build_default_consent_action: function(e, t, i, n) {
                if (!(t.length <= 1 && t.includes("missing_cookie") || t.length <= 0)) {
                    ...
                    r.setAttribute("id", "nf_recaptcha_consent_event"), r.innerText += e.collection.options.formModel.get("settings").recaptchaConsentEvent;
            ...
            updateFieldMergeTags: function(e) {
                _.each(this.htmlFields, (function(e) {
                    ...
                    _.each(this.trackedMergeTags, (function(e) {
                        ...
                        t = t.replace(n, '<span data-key="field:' + e.get("key") + '">' + e.getValue() + "</span>")
        ...
        return Marionette.Object.extend({
            ...
            initTextareaRTEs: function(e) {
                ...
                1 == e.model.get("textarea_media") && 0 != userSettings.uid && i.push(["tools", ["mediaButton"]]), jQuery(e.el).find(".nf-element").summernote({
                    toolbar: i,
                    buttons: {
            ...
            openMediaManager: function(e, t) {
                if (t.invoke("editor.saveRange"), this.meta_image_frame) this.meta_image_frame.open();
                else {
        ...
        return Marionette.Object.extend({
            ...
            addOption: function(e, t) {
                if (t) {
                    ...
                    e.get("options").push(i), e.get("value").push(t), e.trigger("reRender")
                }
            }
        })
        ...
        return Marionette.ItemView.extend({
            ...
            templateHelpers: function() {
                ...
                return {
                    ...
                    renderPlaceholder: function() {
                        ...
                        return void 0 !== this.customPlaceholder && (e = this.customPlaceholder(e)), "" != jQuery.trim(e) ? 'placeholder="' + _.escape(e) + '"' : ""
                    },
            ...
            extraChange: function(e) {
                nfRadio.channel("field-" + this.model.get("id")).trigger("change:extra", e, this.model), nfRadio.channel(this.model.get("type")).trigger("change:extra", e, this.model), nfRadio.channel("fields").trigger("change:extra", e, this.model)
            },
        ...
        return Marionette.ItemView.extend({
            ...
            updateCount: function(e, t) {
                var i = jQuery(e).val(),
                    ...
                    r = n.length,
                    o = i.length;
                if ("characters" == this.model.get("input_limit_type") || "char" == this.model.get("input_limit_type")) jQuery(e).attr("maxlength", this.model.get("input_limit")), this.count = this.model.get("input_limit") - o;
                else {
        ...
        return Marionette.LayoutView.extend({
            ...
            initialize: function() {
                this.collection = this.model.get("sets"), nfRadio.channel("field-repeater").on("rerender:fieldsets", this.render, this), this.listenTo(nfRadio.channel("form-" + this.model.get("formID")), "before:submit", this.beforeSubmit)
            },
            onRender: function() {
        ...
        return Marionette.LayoutView.extend({
            ...
            onRender: function() {
                this.model.get("visible") && (this.beforeField.show(new t({
                    model: this.model
                })), "repeater" == this.model.get("type") ? this.field.show(new n({
                    model: this.model
                })) : this.field.show(new e({
                    model: this.model
                })), this.afterField.show(new i({
        ...
        return Marionette.Object.extend({
            ...
            defaultFormContentLoad: function(e, i, n) {
                ...
                if (1 == _.without(o, void 0).length || void 0 === e || !0 == e instanceof Backbone.Collection) return i.get("fields");
        ...
        return Backbone.Model.extend({
            ...
            getRepeaterFieldById: function(e) {
                let t, i = this.getRepeaterFields();
                if (!(i.length <= 0)) return _.each(i, (function(i) {
                    i.id === e && (t = i)
                })), t
            }
        })
        ...
        return Backbone.Collection.extend({
            model: e,
            initialize: function(e, t) {
                this.options = t, nfRadio.channel("field-repeater").on("sort:fieldsets", this.sortIDs, this), nfRadio.channel("field-repeater").on("remove:fieldset", this.removeSet, this), nfRadio.channel("field-repeater").on("add:fieldset", this.addSet, this)
            },
            addSet: function(e) {
                const i = jQuery(e.target).prev(".nf-repeater").data("field-id"),
                    n = this.options.repeaterFieldModel.id === i ? this.options.repeaterFieldModel : void 0;
                if (void 0 !== n) {
            ...
            sortIDs: function() {
                nfRadio.channel("field-repeater").request("reset:repeaterFieldsets", this.models), _.each(this.models, (function(e, t) {
                    let i = e.get("fields");
                    e.set("index", t + 1), _.each(i.models, (function(e) {
                        cutEl = String(e.id).split("_")[0], e.set("id", cutEl + "_" + t)
                    }))
            ...
            beforeSubmit: function(e) {
                ...
                if (t.length > 0) {
                    ...
                    })), nfRadio.channel("nfAdmin").request("update:field", this.options.repeaterFieldModel, e)
                }
            }
        })
    ...
    })), i("controllers/loadControllers", ["controllers/formData", "controllers/fieldError", "controllers/changeField", "controllers/changeEmail", "controllers/changeDate", "controllers/fieldCheckbox", "controllers/fieldCheckboxList", "controllers/fieldImageList", "controllers/fieldRadio", "controllers/fieldNumber", "controllers/mirrorField", "controllers/confirmField", "controllers/updateFieldModel", "controllers/submitButton", "controllers/submitDebug", "controllers/getFormErrors", "controllers/validateRequired", "controllers/submitError", "controllers/actionRedirect", "controllers/actionSuccess", "controllers/fieldSelect", "controllers/coreSubmitResponse", "controllers/fieldProduct", "controllers/fieldTotal", "controllers/fieldQuantity", "controllers/calculations", "controllers/dateBackwardsCompat", "controllers/fieldDate", "controllers/fieldRecaptcha", "controllers/fieldRecaptchaV3", "controllers/fieldHTML", "controllers/helpText", "controllers/fieldTextbox", "controllers/fieldTextareaRTE", "controllers/fieldStarRating", "controllers/fieldTerms", "controllers/formContentFilters", "controllers/loadViews", "controllers/formErrors", "controllers/submit", "controllers/defaultFilters", "controllers/uniqueFieldError", "controllers/fieldRepeater"], (function(e, t, i, n, r, o, a, l, s, d, c, f, u, h, m, g, p, v, y, b, R, _, w, x, C, F, k, M, T, j, E, q, D, Q, V, O, I, L, S, N, z, A, B) {
        return Marionette.Object.extend({
            initialize: function() {
                new L, new S, new N, new o, new a, new l, new s, new d, new R, new w, new x, new C, new T, new j, new E, new q, new D, new Q, new V, new O, new I, new A, new B, new t, new i, new n, new r, new c, new f, new u, new h, new m, new g, new p, new v, new y, new b, new _, new F, new z, new k, new M, new e
            }
        })
    ...
    var n = function(e, t, i) {
        void 0 !== e && 0 < e.length ? this.locale = e.split("_").join("-") : this.locale = "en-US", this.thousands_sep = t || ",", this.decimal_sep = i || ".", this.uniqueElememts = function(e, t, i) {
            return i.indexOf(e) === t
        }, this.numberDecoder = function(e) {
            var t = "",
                i = !1;
            "-" === (e = e.toString()).charAt(0) && (i = !0, e = e.replace("-", ""));
            ...
            switch (r.length) {
                ...
                case 1:
                    var o = "";
                    if (1 == n.length) separator = n.pop(), o = 3 == e.split(separator).pop().length && separator == this.thousands_sep ? "" : ".";
                    else separator = r.pop();
                    t = e.split(separator).join(o);
                    break;
                case 2:
                    var a, l = r[0];
                    a = "." === l ? new RegExp("[.]", "g") : new RegExp(l, "g"), t = e.replace(a, "");
                    var s, d = r[1];
                    s = "." === d ? new RegExp("[.]", "g") : new RegExp(d, "g"), t = t.replace(s, ".");
                    break;
                default:
                    return "NaN"
            }
